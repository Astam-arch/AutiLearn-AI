    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-3 col-md-6">
                <h5 class="fw-bold mb-3">Support & Info</h5>
                <p class="text-white-50 mb-1"><i class="fa-solid fa-envelope me-2 text-primary"></i> hackathonssp85@gmail.com</p>
                <p class="text-white-50 mb-1"><i class="fa-solid fa-phone me-2 text-primary"></i> +977-98XXXXXXXX</p>
                <p class="text-white-50"><i class="fa-solid fa-location-dot me-2 text-primary"></i> Birtamode,Jhapa</p>
            </div>
        </div>
